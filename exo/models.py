...
model_cards = {
  ...
  "qwen-2.5-1.5b-mlx": { 
    "layers": 28, 
    "repo": { 
      "MLXDynamicShardInferenceEngine": "Vikhrmodels/Vikhr-Qwen-2.5-1.5B-Instruct-MLX_8bit",
      "TinygradDynamicShardInferenceEngine": "Qwen/Qwen1.5-1.8B-Chat",
    }, 
  },
  ### nemotron
...
pretty_name = {
  ...
  "qwen-2.5-1.5b-mlx": "Qwen 2.5 1.5B (Universal)",
